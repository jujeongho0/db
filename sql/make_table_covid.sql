...
CREATE TABLE district (
    ...
    CONSTRAINT chk_district_name CHECK (
       (area_name = '서울' AND (district = '성북구' OR district = '은평구' OR district = '송파구' OR district = '노원구' OR district = '관악구' OR district = '강동구' OR district = '양천구' OR district = '도봉구' OR district = '동작구' OR district = '광진구' OR district = '강남구' OR district = '중랑구' OR district = '서대문구' OR district = '마포구' OR district = '구로구' OR district = '용산구' OR district = '성동구' OR district = '종로구' OR district = '중구' OR district = '동대문구' OR district = '강북구' OR district = '강서구' OR district = '금천구' OR district = '영등포구' OR district = '서초구'))
        ...
        OR (area_name = '대구' AND (district = '중구' OR district = '동구' OR district = '서구' OR district = '남구' OR district = '북구' OR district = '수성구' OR district = '달서구' OR district = '달성군'))
        OR (area_name = '인천' AND (district = '남동구' OR district = '서구' OR district = '계양구' OR district = '중구' OR district = '동구' OR district = '강화군' OR district = '미추홀구' OR district = '연수구' OR district = '부평구' OR district = '옹진군'))
        ...
        OR (area_name = '전북' AND (district = '전주시' OR district = '익산시' OR district = '군산시' OR district = '남원시' OR district = '완주군' OR district = '진안군' OR district = '정읍시' OR district = '김제시' OR district = '고창군' OR district = '부안군' OR district = '임실군' OR district = '순창군' OR district = '장수군' OR district = '무주군'))
        OR (area_name = '전남' AND (district = '순천시' OR district = '여수시' OR district = '광양시' OR district = '보성군' OR district = '목포시' OR district = '나주시' OR district = '장흥군' OR district = '담양군' OR district = '강진군' OR district = '진도군' OR district = '무안군' OR district = '해남군' OR district = '고흥군' OR district = '화순군' OR district = '영암군' OR district = '영광군' OR district = '완도군' OR district = '장성군' OR district = '신안군' OR district = '함평군' OR district = '곡성군' OR district = '구례군'))
        OR (area_name = '경북' AND (district = '경산시' OR district = '포항시' OR district = '울진군' OR district = '경주시' OR district = '구미시' OR district = '청도군' OR district = '영덕군' OR district = '김천시' OR district = '성주군' OR district = '안동시' OR district = '영천시' OR district = '문경시' OR district = '영양군' OR district = '영주시' OR district = '상주시' OR district = '군위군' OR district = '의성군' OR district = '청송군' OR district = '고령군' OR district = '칠곡군' OR district = '예천군' OR district = '봉화군' OR district = '울릉군'))
        OR (area_name = '경남' AND (district = '양산시' OR district = '창원시' OR district = '함안군' OR district = '거제시' OR district = '밀양시' OR district = '창녕군' OR district = '김해시' OR district = '진주시' OR district = '통영시' OR district = '사천시' OR district = '거창군' OR district = '고성군' OR district = '하동군' OR district = '합천군' OR district = '남해군' OR district = '함양군' OR district = '산청군' OR district = '의령군'))
...
CREATE TABLE hospital (
    ...
    CONSTRAINT chk_hospital_district_name_ CHECK (
       (hospital_area = '서울' AND (hospital_district = '성북구' OR hospital_district = '은평구' OR hospital_district = '송파구' OR hospital_district = '노원구' OR hospital_district = '관악구' OR hospital_district = '강동구' OR hospital_district = '양천구' OR hospital_district = '도봉구' OR hospital_district = '동작구' OR hospital_district = '광진구' OR hospital_district = '강남구' OR hospital_district = '중랑구' OR hospital_district = '서대문구' OR hospital_district = '마포구' OR hospital_district = '구로구' OR hospital_district = '용산구' OR hospital_district = '성동구' OR hospital_district = '종로구' OR hospital_district = '중구' OR hospital_district = '동대문구' OR hospital_district = '강북구' OR hospital_district = '강서구' OR hospital_district = '금천구' OR hospital_district = '영등포구' OR hospital_district = '서초구'))
        ...
        OR (hospital_area = '대구' AND (hospital_district = '중구' OR hospital_district = '동구' OR hospital_district = '서구' OR hospital_district = '남구' OR hospital_district = '북구' OR hospital_district = '수성구' OR hospital_district = '달서구' OR hospital_district = '달성군'))
        OR (hospital_area = '인천' AND (hospital_district = '남동구' OR hospital_district = '서구' OR hospital_district = '계양구' OR hospital_district = '중구' OR hospital_district = '동구' OR hospital_district = '강화군' OR hospital_district = '미추홀구' OR hospital_district = '연수구' OR hospital_district = '부평구' OR hospital_district = '옹진군'))
